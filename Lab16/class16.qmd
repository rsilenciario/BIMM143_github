...
```
Instructions: Type your answers to the following 3 questions in the boxed blue form space
provided. Save your answers and upload to our GradeScope site. There are 10 total points on
offer. You can use any resources but please no communication (electronic or otherwise) with
